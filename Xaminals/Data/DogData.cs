    ...
    public static class DogData
    {
        ...
        static DogData()
        {
            ...
            Dogs.Add(new Animal
            {
                ...
                Details = "Aspin (portmanteau asong Pinoy) is the Tagalog language name for mongrel dogs in the Philippines. These dogs are either entirely descended from dogs that are indigenous to the Philippines, or are mixed-breed.",
                ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Askals_or_aspins_are_mongrel_dogs_in_the_Philippines.jpg/330px-Askals_or_aspins_are_mongrel_dogs_in_the_Philippines.jpg"
            });
